...
| # | File | Shows |
| --- | --- | --- |
| 1 | `01-ai-cost-monitor-canvas.png` | PK-05 full canvas after a successful run |
| 2 | `02-dead-letter-replay-canvas.png` | PK-03 all-green replay run (chrome cropped) |
| 3 | `03-dead-letter-statuses.png` | dead_letter table with `replayed` / `skipped_no_target` statuses |
